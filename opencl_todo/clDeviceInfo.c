...
/////////////////////////////////////////////////////////////////////////////
        ...
        err = clGetDeviceInfo(device_id[i], CL_DEVICE_EXTENSIONS, sizeof(cldeviceExtensions), cldeviceExtensions, NULL);
        if (err != CL_SUCCESS)
        {
            printf("Error: Failed to get maximum work item size!\n");
            return EXIT_FAILURE;
        }
        printf("Device extensions are %s\n", cldeviceExtensions);
