...
write (*,*) 'Initialize Fortran interface hdferr   = ',hdferr
...
write (*,*) 'close fortran interface hdferr   = ',hdferr



! ok, so let's do a test here and change one of the four strings in the file ... 
