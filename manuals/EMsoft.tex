...
\lfoot{\textsf{EMSoft--2015} manual, Release 3.0.1, November 20, 2015}
\cfoot{}
...
\date{Program Manual, Release 3.0.1, November 20, 2015}
...
create a file with the name \textsf{EMsoftConfig.json} and enter the following eight lines:
\begin{verbatim}
{
        ...
        "UserLocation" : "Your location or affilication",
        "UserEmail" : "Your email address"
}
\end{verbatim}
Note that the white space at the start of lines 2 through 7 is a tab.  Obviously, you will need to change the paths above.
...
only used by the IDL visualization interface.  Finally, set the variables that start with \textsf{User} to the correct values; these 
