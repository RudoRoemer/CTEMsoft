...
set(CTEMsoft_VERSION_SHORT "${CTEMsoft_VER_MAJOR}.${CTEMsoft_VER_MINOR}")


SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "CTEMsoft Tools")
SET(CPACK_PACKAGE_VENDOR "Dr. Marc De Graef")
SET(CPACK_PACKAGE_DESCRIPTION_FILE "${PROJECT_BINARY_DIR}/ReadMe.md")
SET(CPACK_RESOURCE_FILE_LICENSE "${PROJECT_BINARY_DIR}/License.txt")
SET(CPACK_PACKAGE_VERSION_MAJOR ${CTEMsoft_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${CTEMsoft_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${CTEMsoft_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${CTEMsoft_VERSION})
#SET(CPACK_COMPONENTS_ALL Applications Headers)
#set(CPACK_COMPONENT_APPLICATIONS_DISPLAY_NAME "Applications")
#set(CPACK_COMPONENT_APPLICATIONS_DESCRIPTION  "The CTEMsoft Software Tools Suite")
...
if(APPLE)
    set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-OSX")
...
elseif(WIN32)
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-Win64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-Win32")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    else()
        set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-Unknown")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    endif()
else()
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-${CTEMsoft_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-${CTEMsoft_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
        set(CPACK_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-${CMAKE_SYSTEM_NAME}")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    endif()
endif()


#set(CTEMsoft_WEBSITE_SERVER "CTEMsoft.bluequartz.net")
#set(CTEMsoft_WEBSITE_SERVER_PATH "/var/www/CTEMsoft.bluequartz.net")
#set(CTEMsoft_WEBSITE_SCP_USERNAME "mjackson")
...
if(WIN32 AND NOT UNIX)
  ...
  SET(CPACK_NSIS_DISPLAY_NAME "CTEMsoft Software Tools")
  SET(CPACK_NSIS_HELP_LINK "http:\\\\\\\\CTEMsoft")
  SET(CPACK_NSIS_URL_INFO_ABOUT "http:\\\\\\\\CTEMsoft")
  SET(CPACK_NSIS_CONTACT "CTEMsoft")
  SET(CPACK_NSIS_MODIFY_PATH ON)
  SET(CPACK_GENERATOR "ZIP")
  SET(CPACK_BINARY_ZIP "ON")
  SET(CPACK_PACKAGE_INSTALL_REGISTRY_KEY "CTEMsoft Software Tools")
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "CTEMsoft-${CTEMsoft_VERSION_SHORT}-Source")
